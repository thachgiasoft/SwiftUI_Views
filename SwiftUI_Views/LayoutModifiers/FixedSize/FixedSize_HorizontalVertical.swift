...
Text("By default, when you use .fixedSize(), horizontal and vertical paremeters are both true. Here is an example where horizontal is TRUE and vertical is FALSE:")
    .padding()
    .layoutPriority(1)
